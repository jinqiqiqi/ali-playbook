        ...
        stage('build_bridge') {
            steps {
                ...
                withCredentials ([sshUserPrivateKey(credentialsId: 'gitk', keyFileVariable: 'GIT_K', usernameVariable: 'GIT_U')]) {
                    ...
                    ansiColor('xterm') {
                        ansiblePlaybook credentialsId: 'gitk', disableHostKeyChecking: true, inventory: 'inventory/hosts', playbook: 'dnsmasq.yml', colorized: true, extras: 'addition="${BUILD_URL}"'
                        ansiblePlaybook credentialsId: 'gitk', disableHostKeyChecking: true, inventory: 'inventory/hosts', playbook: 'jenkins.yml', colorized: true, extras: 'addition="${BUILD_URL}"'
                        ansiblePlaybook credentialsId: 'gitk', disableHostKeyChecking: true, inventory: 'inventory/hosts', playbook: 'nginx.yml', colorized: true, extras: 'addition="${BUILD_URL}"'
                        ansiblePlaybook credentialsId: 'gitk', disableHostKeyChecking: true, inventory: 'inventory/hosts', playbook: 'ocserv.yml', colorized: true, extras: 'addition="${BUILD_URL}"'
                        ansiblePlaybook credentialsId: 'gitk', disableHostKeyChecking: true, inventory: 'inventory/hosts', playbook: 'openldap-auth.yml', colorized: true, extras: 'addition="${BUILD_URL}"'
                    }
